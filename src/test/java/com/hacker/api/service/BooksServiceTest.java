...
public class BooksServiceTest {
    protected static Logger logger = LoggerFactory.getLogger(BooksServiceTest.class);
    ...
    public void getBooksFilterBooksCorrectly() throws IOException {
        List<Rateable> books = booksService.getBooks();
    ...
    public void getBookReviewsFilterBooksCorrectly() throws IOException {
        List<Review> reviews = booksService.getBookReviews();
